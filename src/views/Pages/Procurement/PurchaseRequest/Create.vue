<template>
  <div class="mx-auto max-w-screen-2xl relative">
    ...
    <!-- 🔥 BARU: INDIKATOR GARIS LOADING DI PALING ATAS (Di bawah URL Browser) -->
    <div
      v-if="isDataFetching"
    ...
    <!-- ========================================================================= -->
    <!-- 🔥 BARU: CONTAINER SKELETON LOADING (MUNCUL SAAT MASTER DROPDOWN DI-LOAD) -->
    <!-- ========================================================================= -->
    <div
      v-if="isDataFetching"
    ...
    >
      <!-- Tiruan Card Informasi Utama Header -->
      <div
      ...
      <!-- Tiruan Daftar Kebutuhan Barang -->
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label class="block text-sm">Est Kedatangan (Test)</label>
                  <input
                    type="date"
...
<style scoped>
/* 🔥 BARU: STYLE ANIMASI INDETERMINATE MOVEMENT TOP LOADING BAR */
.indeterminate-bar {
  width: 40%;
  position: absolute;
  top: 0;
