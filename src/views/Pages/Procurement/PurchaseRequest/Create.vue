<template>
  <div class="mx-auto max-w-screen-2xl relative">
    ...
    <Breadcrumb pageTitle="Tambah Purchase Request Baru" :crumbs="['Operations', 'Purchase Request', 'Create']" />
    ...
    <div v-if="isDataFetching"
      ...
      <div class="space-y-6">
        <div class="p-5 border border-stroke dark:border-strokedark rounded-lg bg-gray-50/40 dark:bg-meta-4/20">
