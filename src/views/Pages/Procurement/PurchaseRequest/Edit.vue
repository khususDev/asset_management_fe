        ...
        <div>
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
                ...
                <div class="md:col-span-2">
                  ...
                  <select
                    ...
                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-2 px-3 text-sm"
                  >
              ...
              <div
                class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4 bg-gray-50 dark:bg-meta-4 p-3 rounded"
              >
                <div>
                  <label class="mb-1 block text-sm font-medium text-black dark:text-white"
                    >Vendor</label
                ...
                <div>
                  <label class="mb-1 block text-sm font-medium"> Vendor Name </label>

                  <input
                    type="text"
                    v-model="item.vendor_name"
                    placeholder="Nama Toko / Nama Perusahaan"
                    class="w-full rounded border-[1.5px] border-stroke bg-white py-2 px-3 text-sm dark:bg-form-input"
                  />
                </div>
                <div>
